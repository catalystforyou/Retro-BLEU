...
n5_ngram_rxns, n5_ngram_templates, n5_rxns = build_vocab(all_routes, all_templates, excluded_patents=n5_patents)
n5_bigrams = set(n5_ngram_templates[0])
n1_ngram_rxns, n1_ngram_templates, n1_rxns = build_vocab(all_routes, all_templates, excluded_patents=n1_patents)
n1_bigrams = set(n1_ngram_templates[0])
all_ngram_rxns, all_ngram_templates, all_rxns = build_vocab(all_routes, all_templates, [])
all_bigrams = set(all_ngram_templates[0])

pickle.dump(n5_bigrams, open('data/vocab_bigrams_n5.pkl', 'wb'))
pickle.dump(n1_bigrams, open('data/vocab_bigrams_n1.pkl', 'wb'))
pickle.dump(all_bigrams, open('data/vocab_bigrams_all.pkl', 'wb'))
